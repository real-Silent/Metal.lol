    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            // Title and FPS
                ...
                text.text = PluginInfo.Name + " P: <color=white>" + (pageNumber + 1).ToString() + "</color>";
                text.fontSize = 1;
                ...
                component.sizeDelta = new Vector2(0.18f, 0.05f); // (0.284f, 0.05f);
            ...
            // Buttons
                // Disconnect
                    if (disconnectButton)
                    {
                        ...
                        disconnectbutton.transform.localScale = new Vector3(0.09f, 0.7f, 0.08f); //(0.09f, 0.9f, 0.08f);
                        ...
                        rectt.sizeDelta = new Vector2(0.15f, 0.03f); // new Vector2(0.2f, 0.03f);
            ...
            if (TopButtons == true)
            {
                ...
                gameObject.transform.localScale = new Vector3(0.09f, 0.2f, 0.07f); // 0.09f, 0.2f, 0.9f
                gameObject.transform.localPosition = new Vector3(0.56f, 0.50f, 0.45f); // (0.56f, 0.65f, 0);
            ...
            else// back page button ( left side )
            {
                if (TopButtons == false)
                {
                    GameObject gameObject = GameObject.CreatePrimitive(PrimitiveType.Cube);
                    ...
                    gameObject.transform.localPosition = new Vector3(0.56f, 0.50f, 0); // (0.56f, 0.65f, 0);
                    gameObject.GetComponent<Renderer>().material.color = buttonColors[0].colors[0].color;
                    gameObject.AddComponent<Classes.Button>().relatedText = "PreviousPage";
                    ...
                    component.localPosition = new Vector3(0.064f, 0.150f, 0f); // (0.064f, 0.195f, 0f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
                    ...
                    component.localPosition = Vector3.zero;
                    component.sizeDelta = new Vector2(0.2f, 0.03f);
                    component.localPosition = new Vector3(0.064f, -0.150f, 0f);
                    component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
                }
            }
            ...
            ButtonInfo[] activeButtons = buttons[buttonsType].Skip(pageNumber * buttonsPerPage).Take(buttonsPerPage).ToArray();
                    ...
                    {
                        CreateButton(i * 0.135f, activeButtons[i]); // 0.1f
                    }
        }
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.transform.parent = menu.transform;
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.09f, 0.65f, 0.08f); //gameObject.transform.localScale = new Vector3(0.09f, 0.9f, 0.08f);
            ...
            RectTransform component = text.GetComponent<RectTransform>();
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(.15f, .03f); // new Vector2(.2f, .03f);
